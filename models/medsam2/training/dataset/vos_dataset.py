...
def load_images(frames) -> List[PILImage.Image]:
...
def tensor_to_pil(data: torch.Tensor) -> PILImage.Image:   #Retained for any callers outside the main training loop that may still need a PIL representation. Not used internally by _load_images anymore.
